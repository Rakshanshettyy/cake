                        ...
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right">
                                    <span>Sort by </span>
                                    <select id="sort_product_id" onchange="sort_product_drop('<?php echo $cat_id?>','<?php echo SITE_PATH?>')" class="selectpicker show-tick form-control" data-placeholder="INR" >
									...
									<option value="old" <?php echo $old_selected?>>Earliest</option>
								</select>
                                </div>
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action"  href="categories.php?id=<?php echo $list['id']?>" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1"><?php echo $list['categories']?></a>
                                    <?php
											$cat_id=$list['id'];
											$sub_cat_res=mysqli_query($con,"select * from sub_categories where status='1' and categories_id='$cat_id'");
											if(mysqli_num_rows($sub_cat_res)>0){
											?>
                                    <div class="collapse show" id="#<?php echo $list['id']?>" data-parent="#list-group-men">
