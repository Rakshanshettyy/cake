...
function checkprice($con,$price,$productid){
		$result=" ";		
		...
		if($row['price']==$price){
			$result=1/2;
		   return $result;
	    }elseif($row['price2']==$price){
			
		   $result=1;
		   return $result;
	    }elseif($row['price3']==$price){		
		   $result=1.5;
		   return $result;
	    }elseif($row['price4']==$price){
			  $result=2;
			  return $result;
	    }	
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              ...
              <strong>Amount Due:</strong>'.$user_order['total_price'].'
                        ...
                        <p>If you have any questions about this invoice, simply reply to this email or reach out to our <a href="bakenbitesudupi@gmail.com">support team</a> for help.</p>
                        <p>Cheers,
                          <br>The BakeNBites Team</p>
                        <!-- Sub copy -->
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">&copy; 2021 BakeNBites. All rights reserved.</p>
